...
namespace PROG3050.Controllers
{
    ...
    public class ReportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReportId,Name,Content,CreatedDateTime")] Report report)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReportId,Name,Content,CreatedDateTime")] Report report)
        {
