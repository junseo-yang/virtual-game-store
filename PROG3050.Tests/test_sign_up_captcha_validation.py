...
driver.find_element(By.ID, "Input_Email").send_keys("Tester3@gmail.com")
...
Assert
"""
element = driver.find_element(By.XPATH, "/html/body/div[1]/main/div/div/form/div[1]/ul/li")

assert element.text == "Are you bot??"